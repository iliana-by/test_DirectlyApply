...
window_size = 7
daily_data['moving_average'] = (daily_data['eventValue']/daily_data['cnt']).rolling(window=window_size).mean() / 1000
print(daily_data)
...
plt.xlabel('Date')
plt.ylabel('Total daily eventValue moving average (thousands)')
plt.show()
